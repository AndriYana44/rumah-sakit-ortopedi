...
<div class="page-banner overlay-dark bg-image" style="background-image: url({{ asset('') }}assets-compro/assets/img/bg_image_1.jpg);">
                  ...
                  <div class="site-info">
                    <div class="avatar mr-2">
                      <div class="avatar-img">
                        <img src="{{ asset('') }}assets-compro/assets/img/person/person_1.jpg" alt="">
                      </div>
              ...
              <div class="card-blog">
                ...
                <div class="body">
                  ...
                  <div class="site-info">
                    <div class="avatar mr-2">
                      <div class="avatar-img">
                        <img src="{{ asset('') }}assets-compro/assets/img/person/person_4.jpg" alt="">
                      </div>
              ...
              <div class="card-blog">
                ...
                <div class="body">
                  ...
                  <div class="site-info">
                    <div class="avatar mr-2">
                      <div class="avatar-img">
                        <img src="{{ asset('') }}assets-compro/assets/img/person/person_3.jpg" alt="">
                      </div>
            ...
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                <div class="header">
                  ...
                  <a href="blog-details" class="post-thumb">
                    <img src="{{ asset('') }}assets-compro/assets/img/blog/blog_4.jpg" alt="">
                  </a>
                </div>
                <div class="body">
            ...
            <div class="col-sm-6 py-3">
              <div class="card-blog">
                <div class="header">
                  ...
                  <a href="blog-details" class="post-thumb">
                    <img src="{{ asset('') }}assets-compro/assets/img/blog/blog_5.jpg" alt="">
                  </a>
                </div>
                <div class="body">
              ...
              <div class="card-blog">
                ...
                <div class="body">
                  ...
                  <div class="site-info">
                    <div class="avatar mr-2">
                      <div class="avatar-img">
                        <img src="{{ asset('') }}assets-compro/assets/img/person/person_2.jpg" alt="">
                      </div>
  ...
  <div class="page-section banner-home bg-image" style="background-image: url({{ asset('') }}assets-compro/assets/img/banner-pattern.svg);">
    <div class="container py-5 py-lg-0">
      <div class="row align-items-center">
        <div class="col-lg-4 wow zoomIn">
          <div class="img-banner d-none d-lg-block">
            <img src="{{ asset('') }}assets-compro/assets/img/mobile_app.png" alt="">
          </div>
        </div>
        <div class="col-lg-8 wow fadeInRight">
          <h1 class="font-weight-normal mb-3">Get easy access of all features using One Health Application</h1>
          <a href="#"><img src="{{ asset('') }}assets-compro/assets/img/google_play.svg" alt=""></a>
          <a href="#" class="ml-2"><img src="{{ asset('') }}assets-compro/assets/img/app_store.svg" alt=""></a>
        </div>
      </div> <!-- .row -->
    </div> <!-- .container -->
  </div> <!-- .banner-home -->
